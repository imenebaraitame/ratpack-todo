...
public class TodoRecord extends TableRecordImpl<TodoRecord> implements Record4<Long, String, Integer, Boolean> {

    private static final long serialVersionUID = -1410109591;
     ...
     */
    @Override
    public Row4<Long, String, Integer, Boolean> fieldsRow() {
     ...
     */
    @Override
    public Row4<Long, String, Integer, Boolean> valuesRow() {
     ...
     */
    @Override
    public TodoRecord values(Long value1, String value2, Integer value3, Boolean value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TodoRecord(Long id, String title, Integer order, Boolean completed) {
        super(Todo.TODO);
